...
| Password expiry warning | Home page | Banner above app grid (no navigation block) | manual |
...
| Password expired | Login / OAuth | Auth login with expired message | L2, backend |
